...
import 'package:viscus/pages/comments.dart';
import 'package:viscus/pages/home_page.dart';
import 'package:viscus/widgets/custom_image.dart';
...
class _PostState extends State<Post> {
      ...
      builder: (context, snapshot) {
        ...
        return ListTile(
          ...
          trailing: isPostOwner ? IconButton(
            onPressed: () => handleDelePost(context),
  ...
  handleDelePost(BuildContext parentContext){
    return showDialog(
  ...
  deletePost() async {
    ...
    QuerySnapshot comentsSnapshot = await commentsRef
    .document(postId)
    .collection('comments')
    .getDocuments();

     comentsSnapshot.documents.forEach((doc){
      if (doc.exists){
        doc.reference.delete();
      }
    });
    ...
    return GestureDetector(
      ...
      child: Stack(
        ...
        children: <Widget>[
          ...
          showHeart ? Icon(Icons.favorite, size: 120,
